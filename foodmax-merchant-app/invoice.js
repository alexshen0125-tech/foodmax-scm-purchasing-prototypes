...
function rplCard(r,i){
  return `<div class="iv-card" data-i="${i}">
    ...
    <div class="cli">补货单 <b>${r.repl}</b> · 抵扣结算单 ${r.billNo}</div>
    <div class="g">
...
function open(){
  pushPage({title:'开票管理',body:`
    <div class="iv-seg" id="ivseg"><span class="s on" data-s="cust">客户开票</span><span class="s" data-s="svc">服务费</span><span class="s" data-s="rpl">补货</span></div>
    <div id="ivdyn"></div>`,
    mount:(page)=>{
      page._st={seg:'cust'};
