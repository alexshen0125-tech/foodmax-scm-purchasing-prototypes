...
function seed(){return [
 ...
 {id:'M007',cat:'FINANCE',ev:'RECON_GENERATED',lv:'L1',read:0,tm:'2026-08-20 08:00',dl:H(96),
  t:'对账单已生成 · 待核对',b:'2026-08-11 ~ 08-17 的对账单已生成，请尽快核对。对账单仅供逐日核对，货款是否放款以你对本期「结算单」的认可为准；如有差异请线下联系运营。',
 ...
 {id:'M008',cat:'FINANCE',ev:'RECON_DUE_SOON',lv:'L1',read:0,tm:'2026-08-21 08:00',dl:H(22),
  t:'对账单差异待核查',b:'上一期对账单有 2 项差异你尚未核对。系统不会替你自动确认或自动认可账单——请核对后线下联系运营处理，本期结算单需你在结算单列表主动认可后平台才会打款。',
 ...
 {id:'M009',cat:'FINANCE',ev:'SETTLEMENT_GENERATED',lv:'L1',read:0,tm:'2026-08-19 08:00',
  t:'结算单已生成 · 待你认可',b:'本期结算单已生成，应清算 S$8,640.00。核对无误后请在结算单列表点「认可账单」——认可后账单推送财务打款并自动开具服务费发票，且不可撤回。系统不会替你自动认可，不认可则不打款。',
  rel:[['结算单','ST20260818A'],['结算金额','S$8,640.00']],go:['去认可账单','m-settle'],
